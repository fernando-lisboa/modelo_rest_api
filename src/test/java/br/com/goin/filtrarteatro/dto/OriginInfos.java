...
public class OriginInfos {
	...
	public String toString() {
		return "OriginInfos [buttonColor=" + buttonColor + ", mainColor=" + mainColor + ", textColor=" + textColor
				+ ", bigIcon=" + bigIcon + ", logo=" + logo + ", smallIconColored=" + smallIconColored
				+ ", smallIconWhite=" + smallIconWhite + "]";
	}
