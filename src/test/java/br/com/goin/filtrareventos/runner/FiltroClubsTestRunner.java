...
@CucumberOptions(format = {"html:target/cucumber" }, 
			...
			features = {"src/main/resources/feature/searchFilter/filtrarClubsTest.feature" }, 
					plugin = { "pretty",
			"com.cucumber.listener.ExtentCucumberFormatter:target/Relatório de Clubs.html" },
					tags = {"@CT01.1,@CT01.2,@CT01.3"},
			snippets = cucumber.api.SnippetType.CAMELCASE
		)

public class FiltroClubsTestRunner {
	@AfterClass
