...
@CucumberOptions(format = {"html:target/cucumber" }, 
			...
			features = {"src/main/resources/feature/searchFilter/filtrarTeatroTest.feature" }, 
			plugin = { "pretty",
			"com.cucumber.listener.ExtentCucumberFormatter:target/Relatório de Teatros.html" },  
...
public class FiltrarTeatroTestRunner {
	@AfterClass
